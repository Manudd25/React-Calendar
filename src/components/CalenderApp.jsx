...
function CalenderApp() {
    ...
    const isEventDay = (day) => {
        return events.some(event => isSameDay(new Date(currentYear, currentMonth, day), new Date(event.date)))
    }
  ...
  return (
    <div className='calendar-app'>
        <div className='calendar'>
            ...
            {[...Array(daysInMonth).keys().map((day) => (<span key={day + 1} className={`${day + 1 === currentDate.getDate() && currentMonth === currentDate.getMonth() && currentYear === currentDate.getFullYear() ? 'current-day' : ''} ${isEventDay(day +1) ? 'event-day' : ''}`}
